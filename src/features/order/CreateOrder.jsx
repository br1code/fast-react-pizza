...
export async function action({ request }) {
  ...
  const errors = getValidationErrors(order);
  ...
  // TEMPORAL HACK TO DISPATCH AN ACTION FROM HERE. TODO: FIND ANOTHER WAY
  store.dispatch(clearCart());

  return redirect(`/order/${newOrder.id}`);
}

function getValidationErrors(order) {
  const errors = {};

  if (!isValidPhone(order.phone)) {
    errors.phone =
      "Please give us a valid phone number. The delivery might need it to contact you.";
  }
